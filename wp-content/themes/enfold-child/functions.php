...
// add_action( 'post_updated', 'wp_save_post_revision_custom' );
...
/*
Prospect Register form shortcode
*/
...
/*Hide wordpress admin bar for prospect & company user*/
function disable_admin_bar() {
if(is_user_logged_in()){
	$userid=get_current_user_id();
	$user = get_userdata( $userid );
	$user_roles = $user->roles;
	if ( in_array( 'company_user', $user_roles, true ) || in_array( 'prospect', $user_roles, true ) ) {
